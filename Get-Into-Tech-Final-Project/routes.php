...
//change any instance of 'product' to 'event'
...
$controllers = array('pages' => ['home', 'error', 'contact', 'aboutus'],
                    'eventshow' => ['readAll','read','create','update','delete'],
                    'venueaddress' => ['readAll','read','create','update','delete'],
                    );
